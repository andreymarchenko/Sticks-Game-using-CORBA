...
/**
* SticksCORBAApp/SerializedObjectHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from SticksCORBA.idl
* 6 Декабрь 2016 г. 12:53:07 MSK
*/

abstract public class SerializedObjectHelper
{
  private static String  _id = "IDL:SticksCORBAApp/SerializedObject:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (SticksCORBAApp.SerializedObjectHelper.id (), "SerializedObject", __typeCode);
    }
    return __typeCode;
  }
